...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_Q,    KC_D,    KC_R,    KC_W,    KC_B,    KC_MINS,                        KC_EQL , KC_J,    KC_F,    KC_U,    KC_P,    KC_SCLN,    KC_BSLS, \
    KC_TAB,  KC_A,    KC_S,    KC_H,    KC_T,    KC_G,    KC_LBRC,                        KC_RBRC, KC_Y,    KC_N,    KC_E,    KC_O,    KC_I, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_M,    KC_C,    KC_V,    KC_SPC ,                        KC_ENT , KC_K,    KC_L,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
